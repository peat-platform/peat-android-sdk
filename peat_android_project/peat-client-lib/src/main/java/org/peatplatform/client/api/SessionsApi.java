...
import org.peatplatform.client.model.Credentials;
import org.peatplatform.client.model.Session;
import java.util.*;
import java.io.File;
...
public class SessionsApi {
  ...
  //error info- code: 406 reason: "Not Acceptable" model: <none>
  public Session login (Credentials body) throws ApiException {
  ...
  //error info- code: 200 reason: "OK" model: <none>
  //error info- code: 406 reason: "Not Acceptable" model: <none>
  public void logout (Session body) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
    ...
    try {
      String response = apiInvoker.invokeAPI(basePath, path, "DELETE", queryParams, body, headerParams, contentType, httpEntity);
      if(response != null){
        return ;
      }
      else {
  ...
  //error info- code: 200 reason: "OK" model: <none>
  //error info- code: 406 reason: "Not Acceptable" model: <none>
  public Session refreshSession (Session body) throws ApiException {
    // verify required params are set
    if(body == null ) {
       throw new ApiException(400, "missing required params");
    }
