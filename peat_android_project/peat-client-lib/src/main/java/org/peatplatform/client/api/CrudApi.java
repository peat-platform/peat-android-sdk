...
public class CrudApi {
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject create_CrudApi_0 (String authorization, String db, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject query_CrudApi_0 (String authorization, String body) throws ApiException {
    // verify required params are set
    if(authorization == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject createNamedAlt_CrudApi_0 (String authorization, String db, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject createAlt_CrudApi_0 (String authorization, String db, String id, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject readAlt_CrudApi_0 (String authorization, String db, String id) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject updateAlt_CrudApi_0 (String authorization, String db, String id, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject deleteAlt_CrudApi_0 (String authorization, String db, String id) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject patchAlt_CrudApi_0 (String authorization, String db, String id, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Bad Request" model: CreateErrorResponse
  //error info- code: 401 reason: "Not Authorised" model: CreateErrorResponse
  public CRUDObject upsertAlt_CrudApi_0 (String authorization, String db, String id, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Object not found" model: CRUDErrorObject
  //error info- code: 401 reason: "Unauthorised request" model: CRUDErrorObject
  public CRUDObject createNamed_CrudApi_0 (String authorization, String db, String id, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Object not found" model: CRUDErrorObject
  //error info- code: 401 reason: "Unauthorised request" model: CRUDErrorObject
  public CRUDObject get_CrudApi_0 (String authorization, String db, String id) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Object not found" model: CRUDErrorObject
  //error info- code: 401 reason: "Unauthorised request" model: CRUDErrorObject
  public CRUDObject update_CrudApi_0 (String authorization, String db, String id, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Object not found" model: CRUDErrorObject
  //error info- code: 401 reason: "Unauthorised request" model: CRUDErrorObject
  public CRUDObject patch_CrudApi_0 (String authorization, String db, String id, Object body) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null || body == null ) {
       throw new ApiException(400, "missing required params");
    }
  ...
  //error info- code: 400 reason: "Object not found" model: CRUDErrorObject
  //error info- code: 401 reason: "Unauthorised request" model: CRUDErrorObject
  public CRUDObject delete_CrudApi_0 (String authorization, String db, String id) throws ApiException {
    // verify required params are set
    if(authorization == null || db == null || id == null ) {
       throw new ApiException(400, "missing required params");
    }
