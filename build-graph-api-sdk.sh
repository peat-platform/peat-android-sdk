...
#scala -cp target/scala-2.10/swagger-codegen.jar -DskipErrors=true eu.openiict.codegen.AndroidOPENiApiCodegen http://dev.openi-ict.eu/api-spec/v1/api_framework
