...
import eu.openiict.client.async.models.IPeatAPiCall;
...
import eu.openiict.client.utils.PeatUtils;
...
//        });
   ...
   public void getObject(final String objectid, final IPeatResponse<OPENiObject> iPeatResponse) {
   ...
   public void updateObject(final OPENiObject openiObject, final IPeatResponse<OPENiObject> iPeatResponse) {
      ...
      execPeatApiCall(new IPeatAPiCall() {
         ...
         public void onSuccess(Object object) {
            iPeatResponse.onSuccess((OPENiObject) object);
         }
...
//         Log.d(TAG, "deviceT " + System.currentTimeMillis()/1000);
   ...
   public void createObj(final String typeId, final JSONObject jo, final ICreateObjectResult IcreateCloudletObject) {
    ...
    public void createObj(final OPENiObject objectBody, final ICreateObjectResult IcreateCloudletObject) {
        peatConnect(new IAuthTokenResponse() {
           @Override
           public void onSuccess(String authToken) {
              Log.d(TAG, "Create Object");
